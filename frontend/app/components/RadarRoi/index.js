...
function RadarRoi(props) {
    useEffect(() => {
        ...
        let chart = am4core.create("chartRadarROI", am4charts.RadarChart);
        chart.numberFormatter.numberFormat = "#.0M|#.0M|0M|M";
        chart.hiddenState.properties.opacity = 0;
        let title = chart.titles.create();
        // title.text ="Distribution of "+ ptitle+" Spends";
        // title.fontSize = 15;
...
// year slider
        ...
        function createRange(name, continentData, index) {
            ...
            // axisRange.heatRules.push({ target: axisRange.columns.template, property: "fill", minValue: -3, maxValue: 6, min: am4core.color("#000077"), max: am4core.color("#4cd6b0"), dataField: "valueY" });
            // axisRange.heatRules.push()
